...
INSERT INTO EXEMPLAIRE (id_exemplaire, annee_publication, editeur, BIBLIOTHEQUE_ID_BIBLIOTHEQUE, OUVRAGE_ID_OUVRAGE) VALUES (1, 2015,'Hachette', 1, 2);
INSERT INTO EXEMPLAIRE (id_exemplaire, annee_publication, editeur, BIBLIOTHEQUE_ID_BIBLIOTHEQUE, OUVRAGE_ID_OUVRAGE) VALUES (2, 2013,'Editions Confluences', 2, 1);

INSERT INTO EMPRUNT (id_emprunt, date_emprunt, date_retour, prolongation, id_emprunteur, exemplaire_id_exemplaire) VALUES (1, '2020-01-05', '2020-03-05', false, 1, 1);
INSERT INTO EMPRUNT (id_emprunt, date_emprunt, date_retour, prolongation, id_emprunteur, exemplaire_id_exemplaire) VALUES (2, '2020-03-24', '2020-04-07', false, 1, 2);
