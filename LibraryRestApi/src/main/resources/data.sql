...
INSERT INTO EMPRUNTEUR (id_emprunteur, code_postal, libelle_voie, nom_voie, numero_voie, ville, date_inscription, identifiant, adresse_mail, mot_de_passe, nom, prenom, telephone) VALUES (3,'31300', 'Rue', 'Jean Moulin', '17', 'Toulouse', '2020-03-08', 'mrais2','meryem.rais@gmail.com','mdp', 'Rais','Meryem2','0699150101');
INSERT INTO EMPRUNTEUR (id_emprunteur, code_postal, libelle_voie, nom_voie, numero_voie, ville, date_inscription, identifiant, adresse_mail, mot_de_passe, nom, prenom, telephone) VALUES (4,'31300', 'Rue', 'Jean Moulin', '17', 'Toulouse', '2020-03-08', 'mrais3','meryem.rais@gmail.com','mdp', 'Rais','Meryem3','0699150101');
...
/*INSERT INTO RESERVATION(id_reservation, date_reservation, id_emprunteur, id_ouvrage) VALUES (1, '2020-10-18', 1, 2);
INSERT INTO RESERVATION(id_reservation, date_reservation, id_emprunteur, id_ouvrage) VALUES (1, '2020-10-18', 1, 2);*/
